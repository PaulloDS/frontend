  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col gap-3 p-5 border-t border-white/10">
        ...
        <button
          className="flex justify-center items-center gap-2 h-8 bg-violet-700 hover:border-2 border-emerald-400 rounded-full"
          onClick={(e) => {
            e.preventDefault(); // adicionarItem(props.produto)
          }}
        >
